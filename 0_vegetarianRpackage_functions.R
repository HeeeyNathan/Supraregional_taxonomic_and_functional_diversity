##### LOAD CODE FROM VEGETARIAN PACKAGE --------------------
# The vegetarian package is no longer supported, but code is available on github:
# https://github.com/cran/vegetarian/blob/master/R/vegetarian.R
